    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='D:/Mini Project/Face-Recognition-Based-Attendance-System/Attendace_management_system/Attendance/Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"D:\Mini Project\Face-Recognition-Based-Attendance-System\Attendace_management_system\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'D:/Mini Project/Face-Recognition-Based-Attendance-System/Attendace_management_system/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"D:\Mini Project\Face-Recognition-Based-Attendance-System\Attendace_management_system\Attendance\-------Check atttendance-------"')
